...
(define-abbrev-table 'evil-tutor-mode-abbrev-table '())
...
(define-abbrev-table 'global-abbrev-table
  '(
    ("colordp" "#+ATTR_HTML: :style color:#ff1493;" nil 0)
    ("coloror" "#+ATTR_HTML: :style color:#ff4500;" nil 0)
    ("colorsb" "#+ATTR_HTML: :style color:#2196f3;" nil 0)
    ("spokenenglish" "#+ATTR_HTML: :style color:#2196f3; 
   #+BEGIN_QUOTE
   不恰当的表达：
   #+END_QUOTE
   #+ATTR_HTML: :style color:#ff4500; 
   #+BEGIN_QUOTE
   更好的表达：
   #+END_QUOTE
   #+ATTR_HTML: :style color:#ff1493; 
   #+BEGIN_QUOTE
   例句：
   #+END_QUOTE" nil 0)
   ))
